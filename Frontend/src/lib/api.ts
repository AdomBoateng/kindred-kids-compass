...
export const api = {
  ...
  updateTeacher: (teacherId: string, payload: { full_name?: string; email?: string; phone?: string; avatar_url?: string }) => request(`/api/v1/admin/teachers/${teacherId}`, { method: "PATCH", body: JSON.stringify(payload), requiresAuth: true }),
